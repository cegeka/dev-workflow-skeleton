...
docker run -it --net dws-maven --name dws_maven_clean_install -v $(pwd)/../../dws:/usr/src/dws -w /usr/src/dws maven:3.3-jdk-8 mvn clean install -Ddb.host=dws_db_maven -pl '!:dws-acc-tests'
